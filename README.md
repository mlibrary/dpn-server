...
### Configuration Files
Configuration should not need to be adjusted for development
or test. For production and other production-like environments,
such as staging, use ettin to configure the files in config/settings.
